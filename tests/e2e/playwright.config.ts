...
export default defineConfig({
  testDir: "./specs",
  // Logs in the three role test users once via the real Thunder flow and
  // saves storageState per role (see global-setup.ts) — specs start already
  // signed in instead of repeating OIDC+PKCE per file.
